...
<body>
        ...
        <a href="cadastroserviço.php">Cadastrar novo serviço</a><br>
        </main>
        ...
        <nav>
            ...
            <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
